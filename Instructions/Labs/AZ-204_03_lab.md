...
1.  在 **“光栅图形”** 容器中，选择 **“上传”** 上传 **“Allfiles (F):”** 中的 **“graph.jpg”** 文件实验室 VM 上的 **\\Allfiles\\Labs\\03\\Starter** 文件夹。
...
1.  在 **矢量图形** 容器中，选择 **“上传”** 以上传 **Allfiles (F):** 中的 **graph.svg** 文件实验室 VM 上的 **\\Allfiles\\Labs\\03\\Starter** 文件夹。
